...
<table class="navi col-xs-12  col-md-4 col-md-offset-4" >	
	...
	<table class="table">
		...
		<form action="./make_room2.html.php">
			<input  type="submit" class="btn btn-lg btn-block" style="background-color:#e0ffff; color: #808080;border : 1px #e6e6fa solid ; margin-top: 10px; margin-bottom: -8px;" value="목적지 직접입력">
	    </form>
		</tr>
			<!-- 출발지 -->
			<tr>
			<form action="./php/post.php"  method="post">
				...
				<td class="col-md-9">
					...
					<option value="포항역(EDIYA 앞)">포항역 (EDIYA 앞)</option>
					</select>
				</td>
				</label>
			</tr>
			...
			<tr>
				...
				<td class="col-md-5">최대탑승인원</td>
					<td class="col-md-7">
						...
						<div style="color:#34C6BE">※&nbsp; 최소탑승인원: 2명<br> &nbsp;&nbsp;&nbsp;&nbsp;최대탑승인원: 4명<br>&nbsp;&nbsp;&nbsp;&nbsp;법적 탑승인원은 기사님 포함 5명.</div>
					</td>
					</label>
				</tr>
			</tbody>
	...
	<div class="div2">
	<br>
			    <p>Tip: 오전 12:00 = 24:00 / 오후 12:00 = 12:00<br>
			<b>편의를 위해 출발지에서 포항역은 EDIYA앞으로 수정.</b><br>(방 내부에서 탑승자들끼리 변경가능)</p>
	</div>
	</div>
</form>
</body>
