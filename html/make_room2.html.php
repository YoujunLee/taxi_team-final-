...
<body class = "center">
	...
	<table class="table">
		...
		<form action="./make_room_practice2.html.php">
			<input  type="submit" class="btn btn-lg btn-block" style="background-color:#e0ffff; color: #808080;border : 1px #e6e6fa solid ; margin-top: 10px; margin-bottom: -8px;" value="목적지 선택입력">
	    </form>
		</tr>
