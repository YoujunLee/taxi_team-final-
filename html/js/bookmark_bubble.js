...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
    bubbleInner.innerHTML = 'iTaxi 웹앱 다운로드 방법: ' +
        '아래 네모 박스를 누르신후  <b>\'홈 화면에 추가\'</b> 버튼을 누르시오.';
  } else {
    bubbleInner.innerHTML = '<b>iTaxi 웹앱 다운로드 방법:</b> ' +
        '아래 네모 박스를 누르신후 <b style="font-size:15px">+</b> ' +
        '<b>\'홈 화면에 추가\' 버튼을 누르시오.</b>';
  }
