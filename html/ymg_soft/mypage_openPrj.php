...
<tr>
	<td valign="top" width="20%">
		...
		<ul class="nav nav-pills nav-stacked">
 			<li><a href="./mypage_participation.php">Participation</a></li>
			<li class="active"><a href="./mypage_openPrj.php">Open Project</a></li>
	...
	<td>
		...
		<!-- 컨텐츠 부분 -->
		<div style="margin-left:5%;padding-top:5em">
...
$email = $_SESSION['user_id'];
	$db = new DBC;
	$db->DBI();
	$db->query = "select title, content,num from project  where email='".$email."' ORDER BY num desc";
	$db->DBQ();
