...
?>
		...
		<div align="center" style="padding-top:50px; padding-bottom:20px"><p class="text-primary">Choose an option for rewards and payment.</p></div>

     	<div style="margin-left:25%" class="col-lg-10">
	        <div class="radio">
	          <label>
		...
		<ul class="pager">
    		<div align="right" style="margin-right:25%; margin-bottom:5%">   <li><a href="./payment2.php">Next >></a></li></div>
		</ul>
