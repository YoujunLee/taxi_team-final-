...
{
   echo "<script>alert('학번을 입력해주세요.');location.replace('../index.html.php');</script>";
   exit;
}
else if(($pass==null))
{
   echo "<script>alert('비밀번호를 입력해주세요.');location.replace('../index.html.php);</script>";
   exit;
}
else if(($studentid!="" || $pass!=""))
{
   echo "<script>alert('학번과 비밀번호가 맞지 않습니다.');location.replace('../index.html.php');</script>";
   exit;
}
?>
</body>
